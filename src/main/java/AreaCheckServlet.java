...
public class AreaCheckServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Object> list = (ArrayList<Object>) context.getAttribute("list");
        list = list == null ? list = new ArrayList<Object>() : list;
//        context.getAttribute("x");
//        context.getAttribute("y");
//        context.getAttribute("r");
//        context.getAttribute("result");
        list.add(object);
